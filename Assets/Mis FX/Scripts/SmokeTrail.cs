...
public class SmokeTrail : MonoBehaviour {
	...
	private Material linetempMaterial;
	...
	void Start() {
		...
		linetempMaterial = line.material;
	...
	void Update () {
		...
		if ( allPointsAdded ) {
			Vector2 tempMateOffset;
			tempMateOffset = linetempMaterial.mainTextureOffset;
			tempMateOffset.x = lineSegment * ( timeSinceUpdate / updateSpeed );
			linetempMaterial.mainTextureOffset = tempMateOffset;
		}
	}
